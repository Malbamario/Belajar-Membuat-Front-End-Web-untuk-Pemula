...
function makeBookElement(title, author, year, isComplete) {
    ...
    if (isComplete) {
        btnRow.append(
            createButton(["col-4", "me-1", "btn", "btn-primary", "d-flex", "align-items-center", "justify-content-center"], function (parent) {
                addBookToUnread(parent);
            })
        );
    } else {
        btnRow.append(
            createButton(["col-4", "me-1", "btn", "btn-success", "d-flex", "align-items-center", "justify-content-center"], function (parent) {
    ...
    btnRow.append(
        createButton(["col", "mx-1", "btn", "btn-secondary", "d-flex", "align-items-center", "justify-content-center"], function (parent) {
    ...
    btnRow.append(
        createButton(["col-4", "ms-1", "btn", "btn-danger", "d-flex", "align-items-center", "justify-content-center"], function (parent) {
    ...
    if (searchedTitle !== "") {
        ...
        for (book of books) {
            ...
            if (bookTitle.includes(searchedTitle)) {
                ...
                const newBookElement = makeBookElement(
                    book.title,
                    book.author,
                    book.year,
                    book.isComplete
